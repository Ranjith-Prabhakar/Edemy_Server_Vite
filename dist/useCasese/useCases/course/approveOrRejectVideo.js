...
const approveOrRejectVideo = (courseRepository, req, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { courseId, action } = req.body;
        return yield courseRepository.approveOrRejectVideo(courseId, action);
    }
    catch (error) {
