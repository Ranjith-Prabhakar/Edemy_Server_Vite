...
const getVideoPresignedUrl = (cloudStorage, req, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        console.log("req in getVideoPresignedUrl", req.body);
        return yield cloudStorage.getVideoPresignedUrl(req.body.videoName);
    }
    catch (error) {
