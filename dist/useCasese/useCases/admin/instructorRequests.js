...
const instructorRequests = (instructorAgreementRepository, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        return yield instructorAgreementRepository.getAgreements();
    }
    catch (error) {
