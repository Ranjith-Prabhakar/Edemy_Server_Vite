...
const unFreezCategory = (id) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const result = yield categoryModel_1.default.findByIdAndUpdate(id, { status: "active" }, { new: true });
